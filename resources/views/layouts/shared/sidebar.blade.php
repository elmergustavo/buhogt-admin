...
<div class="app-menu dark:bg-gray-900">
    ...
    <div class="srcollbar" data-simplebar>
        <ul class="menu" data-fc-type="accordion">
            ...
            <li class="menu-item">
                <a href="{{ route('second', ['shop', 'products']) }}" class="menu-link">
                    <span class="menu-icon"><i class="mgc_shopping_bag_1_line"></i></span>
                    <span class="menu-text"> Productos </span>
                </a>
            </li>

            <li class="menu-item">
                <a href="{{ route('second', ['shop', 'customers']) }}" class="menu-link">
                    <span class="">
